...
namespace Spellbound.Modifiers.Samples {
    public sealed class SkillModifierDemo : MonoBehaviour {
        [Header("Skill Setup"), SerializeField]
        ...
        [Header("Ring Defaults"), SerializeField]
        private float innerRingDistance = 5f;

        [SerializeField] private float outerRingDistance = 10f;
        [SerializeField] private bool autoRespawn = true;

        [Header("Enemy Movement"), SerializeField]
        private float moveSpeed = 2f;

        [Header("UI Setup"), SerializeField] private Canvas canvas;
        ...
        private void HandleRayOfFrostChannel() {
            ...
            if (_isChannelingRayOfFrost) _rayOfFrost.UpdateChannel(player.position, player.forward);
        }
        ...
        private void CreateUI() {
            ...
            _rayOfFrostButton = CreateHoldButton(panelObj.transform, "Channel Ray of Frost", OnRayOfFrostDown,
                OnRayOfFrostUp);
        ...
        private Button CreateHoldButton(
            Transform parent, string label, UnityEngine.Events.UnityAction onDown,
        ...
        private void CreateSlider(
            Transform parent, float min, float max, float value, UnityEngine.Events.UnityAction<float> onValueChanged) {
        ...
        private void CreateToggle(
            Transform parent, string label, bool isOn, UnityEngine.Events.UnityAction<bool> onValueChanged) {
        ...
        private void UpdateStatusText() {
            ...
            var count = (int)projectile.GetValue("projectile_count");
            var speed = projectile.GetValue("projectile_speed");
            var damage = fire.GetValue("fire_damage");
            var igniteChance = fire.GetValue("ignite_chance");
