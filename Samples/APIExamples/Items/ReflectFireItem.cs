...
namespace Spellbound.Modifiers.Samples {
    ...
    public sealed class ReflectFireItem : ModifiableItem {
        ...
        public ReflectFireItem(float fraction = 0.25f) => _fraction = fraction;
        ...
        protected override void OnEquip(Modifiable target) {
            ...
            if (circuit.TryGetStage(DemoStages.Convert, out var convert))
                convert.Add(new ReflectLeaf(DemoStats.FireDamage, _fraction, DemoConsequences.ReflectedFire), 0, SourceId);
        }
    }
}
